...
//   // fStr += convert(value);
//
//   GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Yellow, *(JOYSTR_CUR_CLASS_LINE + ": " + convert(value)));
//   // fStr.Reset();
// }
//
...
//   // FString aStupidString = FString("Stupid string");
//   // FString fStr = HowIFeelToday + FString(value);
//   // fStr.Contains(TEXT("Test"), ESearchCase::CaseSensitive, ESearchDir::FromEnd);
//   // fStr += value;
//   // fStr.Reset(100);
//   // FString finalStr = FString::Append(HowIFeelToday, aStupidString);
...
// #define print(Param1) (GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Yellow, *(JOYSTR_CUR_CLASS_LINE + ": " + Param1)) )
